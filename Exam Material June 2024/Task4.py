                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            ...
                            self.__AllowedSymbolNumber[CurrentSymbol] = self.__AllowedSymbolNumber[CurrentSymbol] - 1


                            if self.__AllowedSymbolNumber[CurrentSymbol] != 0:
                                print (f"You have got {self.__AllowedSymbolNumber[CurrentSymbol]} {CurrentSymbol}s left. ")
                                return 10

                            else:
                                print (f"You cannot use any more {CurrentSymbol}s. ")
                                return 0
                except:
                    pass
        return 0
